...
kubeadm init --apiserver-advertise-address=10.1.1.36  --pod-network-cidr=10.4.0.0/16  --service-cidr=10.5.0.0/16 --kubernetes-version v1.19.7 --ignore-preflight-errors=FileExisting-conntrack
