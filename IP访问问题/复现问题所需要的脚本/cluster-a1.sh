...
kubeadm init --apiserver-advertise-address=10.1.1.37 --apiserver-cert-extra-sans=localhost,127.0.0.1,10.1.1.37,124.156.237.68 --pod-network-cidr=10.44.0.0/16 --service-cidr=10.45.0.0/16 --kubernetes-version v1.16.0
